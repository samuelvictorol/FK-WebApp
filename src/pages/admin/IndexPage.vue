<template>
    <q-page class="q-pa-md q-gutter-y-md animate__animated animate__fadeIn column items-stretch full-height">
        ...
        <q-card class="w70  q-mb-md">
        <div class="q-pa-sm text-subtitle2">💰 Saldo Atual: R$ 2850,00 <br>📈 Lucro Total: R$ 63021,94</div>
        </q-card>
        <div class="w100 row rounded-borders justify-center align-start">
            <div class="w100 row no-wrap">
                <q-btn class="w100 q-py-xl q-mr-md" label="Formulários" to="/admin/forms" icon-right="list_alt"
                    color="purple-14" glossy></q-btn>
                <q-btn to="/admin/clientes" class="w100 q-py-xl q-mt-md" label="Clientes" icon-right="group"
                    color="blue-14" glossy></q-btn>
            </div>
            <div class="w100">
                <q-btn to="/admin/vendas" class="w100 q-py-xl q-mt-md" label="Painel de Vendas" icon-right="paid"
                    color="green" glossy></q-btn>
            </div>
        </div>
    </q-page>
</template>
