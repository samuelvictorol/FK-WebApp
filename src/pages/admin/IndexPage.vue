<template>
    <q-page padding class="q-px-md">
        <q-card class="q-pa-md q-mx-auto q-mt-xl" style="max-width: 700px; width: 100%;">
            <q-card-section>
                <div class="text-h5">Criar Formulário</div>
            </q-card-section>

            <q-card-section>
                <q-input color="blue-14" v-model="formTemplate.title" label="Título do Formulário" outlined>
            ...
            <q-card-section>
                ...
                <q-input color="blue-14" v-model="questionHandler.question" label="Pergunta" outlined class="q-mb-sm">
                    <template v-slot:append>
                ...
                <div class="row items-start q-col-gutter-sm q-gutter-y-sm animate__animated animate__fadeIn" v-if="questionHandler.question">
                    <!-- opção -->
                    <div class="col-12 col-sm-5">
                        <q-input color="blue-14" v-model="optionHandler.option" label="Opção" outlined>
                            <template v-slot:append>
                    ...
                    <!-- tag -->
                    <div class="col-12 col-sm-5">
                        <q-select v-model="optionHandler.tag" :options="tagsOptions" label="Tag" emit-value
                            map-options outlined option-label="label" option-value="label">
                            <template v-slot:append>
                    ...
                    <div class="col-12 col-sm-2">
                        <q-btn class="w100" color="blue-14" icon="add" glossy  @click="pushOption"
                ...
                <q-btn class="q-mt-md full-width full-width-sm-auto" color="secondary" icon="add_circle"
            ...
            <q-card-actions align="right">
                <q-btn class="w100" color="primary" label="Enviar" icon-right="send" glossy
                    @click="enviarFormulario" :disable="formTemplate.questions.length === 0 || !formTemplate.title" />
            </q-card-actions>
        </q-card>
    </q-page>
</template>
